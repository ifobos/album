...
import com.album.db.album_db.service.RolesService;
...
public class UserBaseService {
	...
	public List<User> findByAlbum(Long idAlbum) {
		
		String sql = "select * from `User` WHERE `Album` = :idAlbum";
		
	    SqlParameterSource parameters = new MapSqlParameterSource()
		.addValue("idAlbum", idAlbum);
