...
import com.album.db.album_db.service.UserService;
import com.album.db.album_db.entity.User;
...
//CRUD METHODS
    ...
    //CRUD - FIND BY Album
    @Secured({ "ROLE_PRIVATE_USER" })
	@RequestMapping(value = "/user/findByAlbum/{key}", method = RequestMethod.GET, headers = "Accept=application/json")
	public List<User> findByAlbum(@PathVariable("key") Long idAlbum) {
		List<User> list = userService.findByAlbum(idAlbum);
		return list;
	}
